...
class CadastroMentorado4 extends Component {
    constructor(props) {
        super(props);
        this.state = {
        ...
        return (
            <div className="">
                ...
                <div className="container text-center my-4">
                    <h4 className="font-weight-bold">Selecione as áreas que têm interesse</h4>
                </div>
                ...
                <form className="container mx-auto" style={{ width: 350 }}>
                    ...
                    <div className="d-flex">
                        <Link className="button-primary float-right my-4" to="/cadastro-mentorado">Revisar</Link>
                        <Link className="button-primary float-left my-4" to="/perfil-mentor">FINALIZAR</Link>
                    </div>
...
export default CadastroMentorado4;