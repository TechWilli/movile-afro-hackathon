      ...
      <div className="">
        ...
        <form className="container mx-auto" style={{ width: 350 }}>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control input-default" id="inputCPF" aria-describedby="cpfHelper" />
            <small id="cpfHelp" class="form-text text-muted">Digite seu CPF sem ponto</small>
          </div>
          ...
          <Link className="button-primary float-right" to="/cadastro-mentor-2">Próximo</Link>
        </form>
